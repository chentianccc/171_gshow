...
export const reqKeys =(geohash,keyword) =>ajax(`/search_shops`,{geohash,keyword})
...
export const reqSencode =(phone) =>ajax(`/sendcode`,{phone})

// [8、手机号验证码登陆](#8手机号验证码登陆)<br/>
export const reqPhone =(phone,code) =>ajax(`/login_sms`,{phone,code})

// [9、根据会话获取用户信息](#9根据会话获取用户信息)<br/>
export const reqPeople =() =>ajax(`/userinfo`)

// [10、用户登出](#10用户登出)<br/>
export const reqQuit =() =>ajax(`/logout`)
